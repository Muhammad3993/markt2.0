        ...
        <div className="order_container">
            {
                        ...
                        <div className="order_main_body_box">
                            ...
                            <div className="order_main_body_box_info">
                                ...
                                <div className="order_main_body_box_info_right">
                                    <div className="order_main_body_box_info_left_box">
                                        <p>Status:</p>
                                        <p><span style={{background: "green"}}></span> Delivered</p>
                                    </div>
                                    <div className="order_main_body_box_info_left_box">
                                        <p>Total cost:</p>
                                        <p>UZS4,920,000</p>
                            ...
                            <div className={isOpenProducts ? "order_main_body_box_products order_main_body_box_products_close" : "order_main_body_box_products"}>
                                <div className="order_main_body_box_product">
                                    ...
                                    <div className="order_main_body_box_product_right">
                                        <p className="order_main_body_box_product_right_title">Price:</p>
                                        <p className="order_main_body_box_product_right_price">4 920 000 sum</p>
                                        <p className="order_main_body_box_product_right_count">1 item</p>
                                    </div>
                                </div>
                ...
                <div className="order_not">
                    <p className="order_not_title">You haven't placed any orders yet</p>
                    <button className="order_not_btn">Shop now</button>
                </div>
            }
        </div>
    </div>
